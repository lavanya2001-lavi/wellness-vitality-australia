  ...
  return (
    <section className="relative py-24 md:py-32 flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-0 w-[40%] h-[40%] bg-blue-50/40 rounded-full blur-[100px]" />
        <div className="absolute bottom-0 right-0 w-[30%] h-[30%] bg-secondary/5 rounded-full blur-[80px]" />
      </div>
      ...
      <div className="relative z-20 w-full max-w-4xl mx-auto px-6 text-center">
        <motion.div {...fade(0)} className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/10 bg-primary/5">
            ...
            <span className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-primary/70">Secure Bookings</span>
          </div>
        </motion.div>
        ...
        <motion.h1 {...fade(1)} className="font-serif font-bold text-primary mb-6"
          ...
          Book Your{" "}
          <span className="text-secondary italic">Wellness Experience</span>
        </motion.h1>

        <motion.p {...fade(2)} className="text-lg text-text-primary/60 leading-relaxed max-w-[45ch] mx-auto font-light">
          Simple, secure, and clinical. Select your treatment and preferred time below to start your journey to vitality.
        </motion.p>
      </div>
    </section>
  );
